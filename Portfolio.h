...
public:
    ...
    virtual int add(double quantity, std::shared_ptr<ContinuousTimeOption> security) = 0;
    ...
    virtual double priceByMonteCarlo(const MultiStockModel &model, const MonteCarloPricer &pricer) const = 0;
    /*  Creates a Portfolio */
